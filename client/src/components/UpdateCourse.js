        ...
        <main>
            <div className="wrap">
                ...
                <form>
                    ...
                    <Link to={'/'}><button className="button" type="submit">Update Course</button><button class="button button-secondary" onclick="event.preventDefault(); location.href='/';">Cancel</button></Link>
                </form>
            </div>
        </main>
    );
